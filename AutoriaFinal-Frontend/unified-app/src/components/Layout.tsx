...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900">
        {/* Public Navigation */}
        <nav className="bg-card-gradient backdrop-blur-md border-b border-brand-blue/20 shadow-xl relative z-[99999]">
        ...
        <nav className="bg-gradient-to-r from-white/8 to-white/5 backdrop-blur-md border-b border-white/15 relative z-[99999]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center space-x-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm">
                    <div className="font-medium text-white">{t('nav.welcome')} {user?.user?.firstName || user?.user?.email}</div>
                  </div>
                </div>
                <button
          ...
          <div className="flex items-center justify-between h-12">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative group z-[99999]">
                ...
                <div className="absolute top-full left-0 mt-2 w-52 z-[99999] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-250 ease-in-out" style={{
                  ...
                  <div className="py-2">
                    ...
                    <Link to="/watchlist" className="block px-4 py-2.5 text-sm text-white hover:text-gray-100 transition-all duration-250 ease-in-out hover:bg-gradient-to-r hover:from-blue-400 hover:to-indigo-400 relative group" style={{
                      borderRadius: '10px',
                      margin: '2px 8px'
                    }}>
                      Watchlist
              ...
              <div className="relative group z-[99999]">
                ...
                <div className="absolute top-full left-0 mt-2 w-52 z-[99999] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-250 ease-in-out" style={{
                  ...
                  <div className="py-2">
                    <Link to="/todays-auctions" className="block px-4 py-2.5 text-sm text-white hover:text-gray-100 transition-all duration-250 ease-in-out hover:bg-gradient-to-r hover:from-blue-400 hover:to-indigo-400 relative group" style={{
                      borderRadius: '10px',
                      margin: '2px 8px'
                    }}>
                      {t('dropdown.todaysAuction')}
                ...
                return isSeller && (
                  <div className="relative group z-[99999]">
                    ...
                    <div className="absolute top-full left-0 mt-2 w-52 z-[99999] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-250 ease-in-out" style={{
                      ...
                      <div className="py-2">
                        <Link to="/add-vehicle" className="block px-4 py-2.5 text-sm text-white hover:text-gray-100 transition-all duration-250 ease-in-out hover:bg-gradient-to-r hover:from-blue-400 hover:to-indigo-400 relative group" style={{
                          borderRadius: '10px',
                          margin: '2px 8px'
                        }}>
                        ...
                        <Link to="/my-vehicles" className="block px-4 py-2.5 text-sm text-white hover:text-gray-100 transition-all duration-250 ease-in-out hover:bg-gradient-to-r hover:from-blue-400 hover:to-indigo-400 relative group" style={{
                          borderRadius: '10px',
                          margin: '2px 8px'
                        }}>
                          My Vehicle
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <Link to="/todays-auctions" className="block text-slate-300 hover:text-blue-500 transition-all duration-300 text-sm relative group">
                  {t('footer.todaysAuctions')}
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-indigo-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
